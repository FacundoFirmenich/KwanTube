...
def main() -> None:
    ...
    # Load inputs
    # -----------------------------------------------------------------------
    spectral_rows = _read_csv(analysis_dir / "spectral_compact.csv")
    structures_rows = _read_csv(analysis_dir / "structures_compact.csv")
    bath_proxy = _read_csv_single(analysis_dir / "bath_params_proxy.csv")
    ...
    out_csv = analysis_dir / "metrics_compact.csv"
    ...
    summary_path = analysis_dir / "metrics_compact_summary.csv"
    summary_fields = [
    ...
    fisher_path = analysis_dir / "fisher_barrier.csv"
    fisher_fields = [
    ...
    # Done
    done_flag = analysis_dir / "_done_compute_detectability_metrics.flag"
