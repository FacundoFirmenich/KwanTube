...
def main() -> None:
    ...
    # Load curated tables
    metrics = _read_csv(analysis_dir / "metrics_compact.csv")
    studies = _read_csv(analysis_dir / "studies_compact.csv")
    structures = _read_csv(analysis_dir / "structures_compact.csv")
    bath_empirical = _read_csv_single(analysis_dir / "bath_params_empirical.csv")
    ...
    # -----------------------------------------------------------------------
    if panels:
        out_csv = analysis_dir / "comparative_panels_compact.csv"
