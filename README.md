...
3. Numerical consistency of the Nested Sampling engine (`scripts/test_ns_consistency.py`).
4. Stability of the Bayesian HEOM hierarchy (`scripts/bayesian_heom_hierarchy_v2.py`).
...
- **Engine**: `scripts/bayesian_heom_hierarchy_v2.py`
...
- `scripts/generate_paper_figures.py`: Manuscript figure generation engine.
